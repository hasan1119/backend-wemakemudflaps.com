...
export const hardDeleteAttribute = async (
  ...
  // First delete any related entries from the product_attribute junction table
  await entityManager
    .createQueryBuilder()
    .delete()
  ...
  // Secondly, delete any related entries from the variation_attribute_values junction table
  await entityManager
    .createQueryBuilder()
    .delete()
