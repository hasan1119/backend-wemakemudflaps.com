...
export type AddToCartOrWishListResponseOrError = BaseResponse | CartResponse | ErrorResponse | WishlistResponse;
...
export type ApplyCouponResponseOrError = BaseResponse | CartResponse | ErrorResponse;
...
export enum CalculateTaxBasedOn {
...
export type Coupon = {
  ...
  maximumSpend?: Maybe<Scalars['Float']['output']>;
  minimumSpend?: Maybe<Scalars['Float']['output']>;
...
export type CreateCouponResponseOrError = BaseResponse | CouponResponse | ErrorResponse;

export type CreateFaqResponseOrError = BaseResponse | ErrorResponse | FaqResponse;
...
export type CreateTaxOptionsResponseOrError = BaseResponse | ErrorResponse | TaxOptionsResponse;
...
export type DeleteCouponResponseOrError = BaseResponse | ErrorResponse;

export type DeleteFaqResponseOrError = BaseResponse | ErrorResponse;
...
export enum DisplayTaxTotals {
  AsASingleItem = 'AS_A_SINGLE_ITEM',
  Itemized = 'ITEMIZED'
}
...
export type FaqPaginationResponse = {
...
export type GetBrandByIdResponseOrError = BaseResponse | BrandResponse | ErrorResponse;
...
export type GetCouponByIdResponseOrError = BaseResponse | CouponResponse | ErrorResponse;

export type GetCouponsResponseOrError = BaseResponse | CouponPaginationResponse | ErrorResponse;

export type GetFaqByIdResponseOrError = BaseResponse | ErrorResponse | FaqResponseById;

export type GetFaqsResponseOrError = BaseResponse | ErrorResponse | FaqPaginationResponse;
...
export type GetShopAddressesResponseOrError = BaseResponse | ErrorResponse | ShopAddressesResponse;

export type GetShopForDefaultTaxResponseOrError = BaseResponse | ErrorResponse | ShopAddressResponse;

export type GetSiteSettingsResponseOrError = BaseResponse | ErrorResponse | SiteSettingsResponse;
...
export type GetTaxOptionsResponseOrError = BaseResponse | ErrorResponse | TaxOptionsResponse;
...
export type Mutation = {
  ...
  addToCart: AddToCartOrWishListResponseOrError;
  addToWishList: AddToCartOrWishListResponseOrError;
  applyCoupon: ApplyCouponResponseOrError;
  ...
  createTaxOptions: CreateTaxOptionsResponseOrError;
  ...
  deleteCoupon: DeleteCouponResponseOrError;
  deleteFaqs: DeleteFaqResponseOrError;
  ...
  updateCoupon: UpdateCouponResponseOrError;
  updateFaq: UpdateFaqResponseOrError;
  ...
  updateTaxOptions: UpdateTaxOptionsResponseOrError;
...
export type MutationCreateCouponArgs = {
  allowedEmails?: InputMaybe<Array<Scalars['String']['input']>>;
  applicableCategories?: InputMaybe<Array<Scalars['ID']['input']>>;
...
export type MutationCreateOrUpdateShopAddressArgs = {
...
export type MutationCreateTaxOptionsArgs = {
  calculateTaxBasedOn: CalculateTaxBasedOn;
  displayPricesDuringCartAndCheckout: Scalars['Boolean']['input'];
  displayPricesInShop: Scalars['Boolean']['input'];
...
export type MutationUpdateTaxOptionsArgs = {
  calculateTaxBasedOn?: InputMaybe<CalculateTaxBasedOn>;
  displayPricesDuringCartAndCheckout: Scalars['Boolean']['input'];
  displayPricesInShop?: InputMaybe<Scalars['Boolean']['input']>;
  displayTaxTotals?: InputMaybe<DisplayTaxTotals>;
...
export type Query = {
  ...
  getShopAddresses: GetShopAddressesResponseOrError;
  getShopForDefaultTax: GetShopForDefaultTaxResponseOrError;
  getSiteSettings: GetSiteSettingsResponseOrError;
  ...
  getTaxOptions: GetTaxOptionsResponseOrError;
...
export type QueryGetAllFaqsArgs = {
  limit: Scalars['Int']['input'];
  page: Scalars['Int']['input'];
  search?: InputMaybe<Scalars['String']['input']>;
  sortBy?: InputMaybe<Scalars['String']['input']>;
...
export type QueryGetShopAddressesArgs = {
  limit: Scalars['Int']['input'];
  page: Scalars['Int']['input'];
  search?: InputMaybe<Scalars['String']['input']>;
};
...
export type RestoreCouponResponseOrError = BaseResponse | ErrorResponse;
...
export type ShopAddress = {
  ...
  id: Scalars['ID']['output'];
  isActive?: Maybe<Scalars['Boolean']['output']>;
  isDefaultForTax?: Maybe<Scalars['Boolean']['output']>;
...
export type ShopAddressInput = {
  ...
  id?: InputMaybe<Scalars['ID']['input']>;
  isActive?: InputMaybe<Scalars['Boolean']['input']>;
  isDefaultForTax?: InputMaybe<Scalars['Boolean']['input']>;
...
export type ShopAddressesResponse = {
...
export type ShopPhone = {
  __typename?: 'ShopPhone';
  number: Scalars['String']['output'];
  type: ShopPhoneType;
};

export type ShopPhoneInput = {
  number: Scalars['String']['input'];
  type: ShopPhoneType;
};

export enum ShopPhoneType {
  Fax = 'Fax',
  Landline = 'Landline',
  Mobile = 'Mobile',
  Other = 'Other'
...
export type TaxOptions = {
  __typename?: 'TaxOptions';
  calculateTaxBasedOn: Scalars['String']['output'];
  createdAt?: Maybe<Scalars['String']['output']>;
  createdBy?: Maybe<CreatedBy>;
  displayPricesDuringCartAndCheckout: Scalars['Boolean']['output'];
  displayPricesInShop: Scalars['Boolean']['output'];
  displayTaxTotals: Scalars['String']['output'];
  id: Scalars['ID']['output'];
...
export type TaxRate = {
  __typename?: 'TaxRate';
  appliesToShipping?: Maybe<Scalars['Boolean']['output']>;
  city?: Maybe<Scalars['String']['output']>;
  country?: Maybe<Scalars['String']['output']>;
  createdAt?: Maybe<Scalars['String']['output']>;
  createdBy?: Maybe<CreatedBy>;
...
export type UpdateCouponResponseOrError = BaseResponse | CouponResponse | ErrorResponse;

export type UpdateFaqResponseOrError = BaseResponse | ErrorResponse | FaqResponse;
...
export type UpdateTaxOptionsResponseOrError = BaseResponse | ErrorResponse | TaxOptionsResponse;
...
export enum DiscountType {
  FixedCartDiscount = 'FIXED_CART_DISCOUNT',
  FixedProductDiscount = 'FIXED_PRODUCT_DISCOUNT',
...
export type ResolversUnionTypes<_RefType extends Record<string, unknown>> = {
  ...
  AddToCartOrWishListResponseOrError: ( BaseResponse ) | ( CartResponse ) | ( ErrorResponse ) | ( WishlistResponse );
  ApplyCouponResponseOrError: ( BaseResponse ) | ( CartResponse ) | ( ErrorResponse );
  ...
  CreateTaxOptionsResponseOrError: ( BaseResponse ) | ( ErrorResponse ) | ( TaxOptionsResponse );
  ...
  DeleteCouponResponseOrError: ( BaseResponse ) | ( ErrorResponse );
  DeleteFaqResponseOrError: ( BaseResponse ) | ( ErrorResponse );
  ...
  GetCouponsResponseOrError: ( BaseResponse ) | ( CouponPaginationResponse ) | ( ErrorResponse );
  GetFaqByIDResponseOrError: ( BaseResponse ) | ( ErrorResponse ) | ( FaqResponseById );
  GetFaqsResponseOrError: ( BaseResponse ) | ( ErrorResponse ) | ( FaqPaginationResponse );
  ...
  GetShopAddressesResponseOrError: ( BaseResponse ) | ( ErrorResponse ) | ( ShopAddressesResponse );
  GetShopForDefaultTaxResponseOrError: ( BaseResponse ) | ( ErrorResponse ) | ( ShopAddressResponse );
  GetSiteSettingsResponseOrError: ( BaseResponse ) | ( ErrorResponse ) | ( SiteSettingsResponse );
  ...
  GetTaxOptionsResponseOrError: ( BaseResponse ) | ( ErrorResponse ) | ( TaxOptionsResponse );
  ...
  RemoveFromCartOrWishListResponseOrError: ( BaseResponse ) | ( ErrorResponse );
  RestoreBrandResponseOrError: ( BaseResponse ) | ( ErrorResponse );
  RestoreCategoryResponseOrError: ( BaseResponse ) | ( ErrorResponse );
  RestoreCouponResponseOrError: ( BaseResponse ) | ( ErrorResponse );
  ...
  UpdateCouponResponseOrError: ( BaseResponse ) | ( CouponResponse ) | ( ErrorResponse );
  UpdateFaqResponseOrError: ( BaseResponse ) | ( ErrorResponse ) | ( FaqResponse );
  ...
  UpdateTaxOptionsResponseOrError: ( BaseResponse ) | ( ErrorResponse ) | ( TaxOptionsResponse );
...
export type ResolversTypes = {
  ...
  AddToCartOrWishListResponseOrError: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['AddToCartOrWishListResponseOrError']>;
  ...
  CouponResponse: ResolverTypeWrapper<CouponResponse>;
  ...
  CreateTaxOptionsResponseOrError: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['CreateTaxOptionsResponseOrError']>;
  ...
  DeleteCouponResponseOrError: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['DeleteCouponResponseOrError']>;
  DeleteFaqResponseOrError: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['DeleteFaqResponseOrError']>;
  ...
  FaqPaginationResponse: ResolverTypeWrapper<FaqPaginationResponse>;
  ...
  GetCouponsResponseOrError: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['GetCouponsResponseOrError']>;
  GetFaqByIDResponseOrError: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['GetFaqByIDResponseOrError']>;
  GetFaqsResponseOrError: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['GetFaqsResponseOrError']>;
  ...
  GetShopAddressesResponseOrError: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['GetShopAddressesResponseOrError']>;
  GetShopForDefaultTaxResponseOrError: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['GetShopForDefaultTaxResponseOrError']>;
  GetSiteSettingsResponseOrError: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['GetSiteSettingsResponseOrError']>;
  ...
  GetTaxOptionsResponseOrError: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['GetTaxOptionsResponseOrError']>;
  ...
  RestoreCouponResponseOrError: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['RestoreCouponResponseOrError']>;
  ...
  ShopAddressInput: ShopAddressInput;
  ShopAddressResponse: ResolverTypeWrapper<ShopAddressResponse>;
  ShopAddressesResponse: ResolverTypeWrapper<ShopAddressesResponse>;
  ShopEmail: ResolverTypeWrapper<ShopEmail>;
  ShopEmailInput: ShopEmailInput;
  ShopEmailType: ShopEmailType;
  ShopPhone: ResolverTypeWrapper<ShopPhone>;
  ShopPhoneInput: ShopPhoneInput;
  ShopPhoneType: ShopPhoneType;
  SinglePermissionInput: SinglePermissionInput;
  SiteSettings: ResolverTypeWrapper<SiteSettings>;
  SiteSettingsResponse: ResolverTypeWrapper<SiteSettingsResponse>;
  ...
  TaxOptions: ResolverTypeWrapper<TaxOptions>;
  TaxOptionsResponse: ResolverTypeWrapper<TaxOptionsResponse>;
  ...
  UpdateCouponResponseOrError: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['UpdateCouponResponseOrError']>;
  UpdateFaqResponseOrError: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['UpdateFaqResponseOrError']>;
  ...
  UpdateTaxOptionsResponseOrError: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['UpdateTaxOptionsResponseOrError']>;
  ...
  WishlistResponse: ResolverTypeWrapper<WishlistResponse>;
  discountType: DiscountType;
...
export type ResolversParentTypes = {
  ...
  AddToCartOrWishListResponseOrError: ResolversUnionTypes<ResolversParentTypes>['AddToCartOrWishListResponseOrError'];
  AddressBook: AddressBook;
  ...
  CreateTaxOptionsResponseOrError: ResolversUnionTypes<ResolversParentTypes>['CreateTaxOptionsResponseOrError'];
  ...
  DeleteCouponResponseOrError: ResolversUnionTypes<ResolversParentTypes>['DeleteCouponResponseOrError'];
  DeleteFaqResponseOrError: ResolversUnionTypes<ResolversParentTypes>['DeleteFaqResponseOrError'];
  ...
  Faq: Faq;
  FaqPaginationResponse: FaqPaginationResponse;
  ...
  GetCouponsResponseOrError: ResolversUnionTypes<ResolversParentTypes>['GetCouponsResponseOrError'];
  GetFaqByIDResponseOrError: ResolversUnionTypes<ResolversParentTypes>['GetFaqByIDResponseOrError'];
  GetFaqsResponseOrError: ResolversUnionTypes<ResolversParentTypes>['GetFaqsResponseOrError'];
  ...
  GetShopAddressesResponseOrError: ResolversUnionTypes<ResolversParentTypes>['GetShopAddressesResponseOrError'];
  GetShopForDefaultTaxResponseOrError: ResolversUnionTypes<ResolversParentTypes>['GetShopForDefaultTaxResponseOrError'];
  GetSiteSettingsResponseOrError: ResolversUnionTypes<ResolversParentTypes>['GetSiteSettingsResponseOrError'];
  ...
  GetTaxOptionsResponseOrError: ResolversUnionTypes<ResolversParentTypes>['GetTaxOptionsResponseOrError'];
  ...
  RestoreCouponResponseOrError: ResolversUnionTypes<ResolversParentTypes>['RestoreCouponResponseOrError'];
  ...
  ShopAddressesResponse: ShopAddressesResponse;
  ShopEmail: ShopEmail;
  ShopEmailInput: ShopEmailInput;
  ShopPhone: ShopPhone;
  ShopPhoneInput: ShopPhoneInput;
  SinglePermissionInput: SinglePermissionInput;
  SiteSettings: SiteSettings;
  SiteSettingsResponse: SiteSettingsResponse;
  Tag: Tag;
  ...
  TaxOptions: TaxOptions;
  TaxOptionsResponse: TaxOptionsResponse;
  TaxRate: TaxRate;
  ...
  UpdateCouponResponseOrError: ResolversUnionTypes<ResolversParentTypes>['UpdateCouponResponseOrError'];
  UpdateFaqResponseOrError: ResolversUnionTypes<ResolversParentTypes>['UpdateFaqResponseOrError'];
  UpdateMediaInput: UpdateMediaInput;
  ...
  UpdateTaxOptionsResponseOrError: ResolversUnionTypes<ResolversParentTypes>['UpdateTaxOptionsResponseOrError'];
...
export type AddToCartOrWishListResponseOrErrorResolvers<ContextType = Context, ParentType extends ResolversParentTypes['AddToCartOrWishListResponseOrError'] = ResolversParentTypes['AddToCartOrWishListResponseOrError']> = {
...
export type ApplyCouponResponseOrErrorResolvers<ContextType = Context, ParentType extends ResolversParentTypes['ApplyCouponResponseOrError'] = ResolversParentTypes['ApplyCouponResponseOrError']> = {
  __resolveType: TypeResolveFn<'BaseResponse' | 'CartResponse' | 'ErrorResponse', ParentType, ContextType>;
};
...
export type CartResponseResolvers<ContextType = Context, ParentType extends ResolversParentTypes['CartResponse'] = ResolversParentTypes['CartResponse']> = {
...
export type CouponResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Coupon'] = ResolversParentTypes['Coupon']> = {
  ...
  maximumSpend?: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  minimumSpend?: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  usageCount?: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type CouponPaginationResponseResolvers<ContextType = Context, ParentType extends ResolversParentTypes['CouponPaginationResponse'] = ResolversParentTypes['CouponPaginationResponse']> = {
  coupons?: Resolver<Array<ResolversTypes['Coupon']>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  statusCode?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  success?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
...
export type CouponResponseResolvers<ContextType = Context, ParentType extends ResolversParentTypes['CouponResponse'] = ResolversParentTypes['CouponResponse']> = {
...
export type CreateCouponResponseOrErrorResolvers<ContextType = Context, ParentType extends ResolversParentTypes['CreateCouponResponseOrError'] = ResolversParentTypes['CreateCouponResponseOrError']> = {
  __resolveType: TypeResolveFn<'BaseResponse' | 'CouponResponse' | 'ErrorResponse', ParentType, ContextType>;
};

export type CreateFaqResponseOrErrorResolvers<ContextType = Context, ParentType extends ResolversParentTypes['CreateFaqResponseOrError'] = ResolversParentTypes['CreateFaqResponseOrError']> = {
  __resolveType: TypeResolveFn<'BaseResponse' | 'ErrorResponse' | 'FaqResponse', ParentType, ContextType>;
};

export type CreateOrUpdateShopAddressResponseOrErrorResolvers<ContextType = Context, ParentType extends ResolversParentTypes['CreateOrUpdateShopAddressResponseOrError'] = ResolversParentTypes['CreateOrUpdateShopAddressResponseOrError']> = {
...
export type CreateTaxOptionsResponseOrErrorResolvers<ContextType = Context, ParentType extends ResolversParentTypes['CreateTaxOptionsResponseOrError'] = ResolversParentTypes['CreateTaxOptionsResponseOrError']> = {
  __resolveType: TypeResolveFn<'BaseResponse' | 'ErrorResponse' | 'TaxOptionsResponse', ParentType, ContextType>;
};
...
export type DeleteCouponResponseOrErrorResolvers<ContextType = Context, ParentType extends ResolversParentTypes['DeleteCouponResponseOrError'] = ResolversParentTypes['DeleteCouponResponseOrError']> = {
  __resolveType: TypeResolveFn<'BaseResponse' | 'ErrorResponse', ParentType, ContextType>;
};

export type DeleteFaqResponseOrErrorResolvers<ContextType = Context, ParentType extends ResolversParentTypes['DeleteFaqResponseOrError'] = ResolversParentTypes['DeleteFaqResponseOrError']> = {
  __resolveType: TypeResolveFn<'BaseResponse' | 'ErrorResponse', ParentType, ContextType>;
};
...
export type FaqPaginationResponseResolvers<ContextType = Context, ParentType extends ResolversParentTypes['FaqPaginationResponse'] = ResolversParentTypes['FaqPaginationResponse']> = {
...
export type FaqResponseResolvers<ContextType = Context, ParentType extends ResolversParentTypes['FaqResponse'] = ResolversParentTypes['FaqResponse']> = {
  faq?: Resolver<ResolversTypes['Faq'], ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  statusCode?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  success?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type FaqResponseByIdResolvers<ContextType = Context, ParentType extends ResolversParentTypes['FaqResponseById'] = ResolversParentTypes['FaqResponseById']> = {
  faq?: Resolver<ResolversTypes['Faq'], ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  statusCode?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  success?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
...
export type GetCouponByIdResponseOrErrorResolvers<ContextType = Context, ParentType extends ResolversParentTypes['GetCouponByIDResponseOrError'] = ResolversParentTypes['GetCouponByIDResponseOrError']> = {
  __resolveType: TypeResolveFn<'BaseResponse' | 'CouponResponse' | 'ErrorResponse', ParentType, ContextType>;
};

export type GetCouponsResponseOrErrorResolvers<ContextType = Context, ParentType extends ResolversParentTypes['GetCouponsResponseOrError'] = ResolversParentTypes['GetCouponsResponseOrError']> = {
  __resolveType: TypeResolveFn<'BaseResponse' | 'CouponPaginationResponse' | 'ErrorResponse', ParentType, ContextType>;
};

export type GetFaqByIdResponseOrErrorResolvers<ContextType = Context, ParentType extends ResolversParentTypes['GetFaqByIDResponseOrError'] = ResolversParentTypes['GetFaqByIDResponseOrError']> = {
  __resolveType: TypeResolveFn<'BaseResponse' | 'ErrorResponse' | 'FaqResponseById', ParentType, ContextType>;
};

export type GetFaqsResponseOrErrorResolvers<ContextType = Context, ParentType extends ResolversParentTypes['GetFaqsResponseOrError'] = ResolversParentTypes['GetFaqsResponseOrError']> = {
  __resolveType: TypeResolveFn<'BaseResponse' | 'ErrorResponse' | 'FaqPaginationResponse', ParentType, ContextType>;
};
...
export type GetShopAddressesResponseOrErrorResolvers<ContextType = Context, ParentType extends ResolversParentTypes['GetShopAddressesResponseOrError'] = ResolversParentTypes['GetShopAddressesResponseOrError']> = {
  __resolveType: TypeResolveFn<'BaseResponse' | 'ErrorResponse' | 'ShopAddressesResponse', ParentType, ContextType>;
};

export type GetShopForDefaultTaxResponseOrErrorResolvers<ContextType = Context, ParentType extends ResolversParentTypes['GetShopForDefaultTaxResponseOrError'] = ResolversParentTypes['GetShopForDefaultTaxResponseOrError']> = {
  __resolveType: TypeResolveFn<'BaseResponse' | 'ErrorResponse' | 'ShopAddressResponse', ParentType, ContextType>;
};

export type GetSiteSettingsResponseOrErrorResolvers<ContextType = Context, ParentType extends ResolversParentTypes['GetSiteSettingsResponseOrError'] = ResolversParentTypes['GetSiteSettingsResponseOrError']> = {
  __resolveType: TypeResolveFn<'BaseResponse' | 'ErrorResponse' | 'SiteSettingsResponse', ParentType, ContextType>;
};
...
export type GetTaxOptionsResponseOrErrorResolvers<ContextType = Context, ParentType extends ResolversParentTypes['GetTaxOptionsResponseOrError'] = ResolversParentTypes['GetTaxOptionsResponseOrError']> = {
  __resolveType: TypeResolveFn<'BaseResponse' | 'ErrorResponse' | 'TaxOptionsResponse', ParentType, ContextType>;
};
...
export type MutationResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  ...
  createTaxOptions?: Resolver<ResolversTypes['CreateTaxOptionsResponseOrError'], ParentType, ContextType, RequireFields<MutationCreateTaxOptionsArgs, 'calculateTaxBasedOn' | 'displayPricesDuringCartAndCheckout' | 'displayPricesInShop' | 'displayTaxTotals' | 'priceDisplaySuffix' | 'pricesEnteredWithTax' | 'roundTaxAtSubtotalLevel'>>;
  ...
  deleteFaqs?: Resolver<ResolversTypes['DeleteFaqResponseOrError'], ParentType, ContextType, RequireFields<MutationDeleteFaqsArgs, 'ids'>>;
  ...
  deleteProductAttribute?: Resolver<ResolversTypes['BaseResponse'], ParentType, ContextType, RequireFields<MutationDeleteProductAttributeArgs, 'ids'>>;
  ...
  removeItemsFromWishList?: Resolver<ResolversTypes['RemoveFromCartOrWishListResponseOrError'], ParentType, ContextType, RequireFields<MutationRemoveItemsFromWishListArgs, 'wishListItemIds'>>;
  ...
  updateFaq?: Resolver<ResolversTypes['UpdateFaqResponseOrError'], ParentType, ContextType, RequireFields<MutationUpdateFaqArgs, 'id'>>;
  ...
  updateTaxOptions?: Resolver<ResolversTypes['UpdateTaxOptionsResponseOrError'], ParentType, ContextType, RequireFields<MutationUpdateTaxOptionsArgs, 'displayPricesDuringCartAndCheckout'>>;
...
export type ProductVariationResolvers<ContextType = Context, ParentType extends ResolversParentTypes['ProductVariation'] = ResolversParentTypes['ProductVariation']> = {
  attributeValues?: Resolver<Maybe<Array<ResolversTypes['ProductAttributeValue']>>, ParentType, ContextType>;
  brands?: Resolver<Maybe<Array<ResolversTypes['Brand']>>, ParentType, ContextType>;
  createdAt?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  defaultQuantity?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  defaultWarrantyPeriod?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type QueryResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  ...
  getShopAddresses?: Resolver<ResolversTypes['GetShopAddressesResponseOrError'], ParentType, ContextType, RequireFields<QueryGetShopAddressesArgs, 'limit' | 'page'>>;
  getShopForDefaultTax?: Resolver<ResolversTypes['GetShopForDefaultTaxResponseOrError'], ParentType, ContextType>;
  getSiteSettings?: Resolver<ResolversTypes['GetSiteSettingsResponseOrError'], ParentType, ContextType>;
  ...
  getTaxOptions?: Resolver<ResolversTypes['GetTaxOptionsResponseOrError'], ParentType, ContextType>;
...
export type RestoreCouponResponseOrErrorResolvers<ContextType = Context, ParentType extends ResolversParentTypes['RestoreCouponResponseOrError'] = ResolversParentTypes['RestoreCouponResponseOrError']> = {
  __resolveType: TypeResolveFn<'BaseResponse' | 'ErrorResponse', ParentType, ContextType>;
};
...
export type ShopAddressResolvers<ContextType = Context, ParentType extends ResolversParentTypes['ShopAddress'] = ResolversParentTypes['ShopAddress']> = {
  ...
  brunchName?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  city?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  country?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  ...
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  isActive?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  isDefaultForTax?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
...
export type ShopAddressResponseResolvers<ContextType = Context, ParentType extends ResolversParentTypes['ShopAddressResponse'] = ResolversParentTypes['ShopAddressResponse']> = {
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  shopAddress?: Resolver<ResolversTypes['ShopAddress'], ParentType, ContextType>;
  statusCode?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  success?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ShopAddressesResponseResolvers<ContextType = Context, ParentType extends ResolversParentTypes['ShopAddressesResponse'] = ResolversParentTypes['ShopAddressesResponse']> = {
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  shopAddresses?: Resolver<Array<ResolversTypes['ShopAddress']>, ParentType, ContextType>;
  statusCode?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  success?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  total?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type ShopEmailResolvers<ContextType = Context, ParentType extends ResolversParentTypes['ShopEmail'] = ResolversParentTypes['ShopEmail']> = {
  email?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  type?: Resolver<ResolversTypes['ShopEmailType'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ShopPhoneResolvers<ContextType = Context, ParentType extends ResolversParentTypes['ShopPhone'] = ResolversParentTypes['ShopPhone']> = {
  number?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  type?: Resolver<ResolversTypes['ShopPhoneType'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type SiteSettingsResponseResolvers<ContextType = Context, ParentType extends ResolversParentTypes['SiteSettingsResponse'] = ResolversParentTypes['SiteSettingsResponse']> = {
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  siteSettings?: Resolver<ResolversTypes['SiteSettings'], ParentType, ContextType>;
  statusCode?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  success?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type TaxOptionsResolvers<ContextType = Context, ParentType extends ResolversParentTypes['TaxOptions'] = ResolversParentTypes['TaxOptions']> = {
  calculateTaxBasedOn?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  createdAt?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  createdBy?: Resolver<Maybe<ResolversTypes['CreatedBy']>, ParentType, ContextType>;
  displayPricesDuringCartAndCheckout?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  displayPricesInShop?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  displayTaxTotals?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type TaxRateResolvers<ContextType = Context, ParentType extends ResolversParentTypes['TaxRate'] = ResolversParentTypes['TaxRate']> = {
  appliesToShipping?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  city?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  country?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  createdAt?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  createdBy?: Resolver<Maybe<ResolversTypes['CreatedBy']>, ParentType, ContextType>;
  deletedAt?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  isCompound?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
...
export type UpdateCouponResponseOrErrorResolvers<ContextType = Context, ParentType extends ResolversParentTypes['UpdateCouponResponseOrError'] = ResolversParentTypes['UpdateCouponResponseOrError']> = {
  __resolveType: TypeResolveFn<'BaseResponse' | 'CouponResponse' | 'ErrorResponse', ParentType, ContextType>;
};

export type UpdateFaqResponseOrErrorResolvers<ContextType = Context, ParentType extends ResolversParentTypes['UpdateFaqResponseOrError'] = ResolversParentTypes['UpdateFaqResponseOrError']> = {
  __resolveType: TypeResolveFn<'BaseResponse' | 'ErrorResponse' | 'FaqResponse', ParentType, ContextType>;
};
...
export type UpdateTaxOptionsResponseOrErrorResolvers<ContextType = Context, ParentType extends ResolversParentTypes['UpdateTaxOptionsResponseOrError'] = ResolversParentTypes['UpdateTaxOptionsResponseOrError']> = {
  __resolveType: TypeResolveFn<'BaseResponse' | 'ErrorResponse' | 'TaxOptionsResponse', ParentType, ContextType>;
};
...
export type WishlistItemsResolvers<ContextType = Context, ParentType extends ResolversParentTypes['WishlistItems'] = ResolversParentTypes['WishlistItems']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  product?: Resolver<ResolversTypes['Product'], ParentType, ContextType>;
  productVariation?: Resolver<Maybe<ResolversTypes['ProductVariation']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type WishlistResponseResolvers<ContextType = Context, ParentType extends ResolversParentTypes['WishlistResponse'] = ResolversParentTypes['WishlistResponse']> = {
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  statusCode?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  success?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
...
export type Resolvers<ContextType = Context> = {
  ...
  AddToCartOrWishListResponseOrError?: AddToCartOrWishListResponseOrErrorResolvers<ContextType>;
  ...
  ApplyCouponResponseOrError?: ApplyCouponResponseOrErrorResolvers<ContextType>;
  ...
  CouponCategory?: CouponCategoryResolvers<ContextType>;
  CouponPaginationResponse?: CouponPaginationResponseResolvers<ContextType>;
  CouponProduct?: CouponProductResolvers<ContextType>;
  CouponResponse?: CouponResponseResolvers<ContextType>;
  ...
  CreateTaxOptionsResponseOrError?: CreateTaxOptionsResponseOrErrorResolvers<ContextType>;
  ...
  DeleteCouponResponseOrError?: DeleteCouponResponseOrErrorResolvers<ContextType>;
  DeleteFaqResponseOrError?: DeleteFaqResponseOrErrorResolvers<ContextType>;
  ...
  FaqPaginationResponse?: FaqPaginationResponseResolvers<ContextType>;
  FaqResponse?: FaqResponseResolvers<ContextType>;
  FaqResponseById?: FaqResponseByIdResolvers<ContextType>;
  ...
  GetCouponsResponseOrError?: GetCouponsResponseOrErrorResolvers<ContextType>;
  GetFaqByIDResponseOrError?: GetFaqByIdResponseOrErrorResolvers<ContextType>;
  GetFaqsResponseOrError?: GetFaqsResponseOrErrorResolvers<ContextType>;
  ...
  GetShopAddressesResponseOrError?: GetShopAddressesResponseOrErrorResolvers<ContextType>;
  GetShopForDefaultTaxResponseOrError?: GetShopForDefaultTaxResponseOrErrorResolvers<ContextType>;
  GetSiteSettingsResponseOrError?: GetSiteSettingsResponseOrErrorResolvers<ContextType>;
  ...
  GetTaxOptionsResponseOrError?: GetTaxOptionsResponseOrErrorResolvers<ContextType>;
  ...
  RestoreCouponResponseOrError?: RestoreCouponResponseOrErrorResolvers<ContextType>;
  ...
  ShopAddressResponse?: ShopAddressResponseResolvers<ContextType>;
  ShopAddressesResponse?: ShopAddressesResponseResolvers<ContextType>;
  ShopEmail?: ShopEmailResolvers<ContextType>;
  ShopPhone?: ShopPhoneResolvers<ContextType>;
  SiteSettings?: SiteSettingsResolvers<ContextType>;
  SiteSettingsResponse?: SiteSettingsResponseResolvers<ContextType>;
  ...
  TaxOptions?: TaxOptionsResolvers<ContextType>;
  TaxOptionsResponse?: TaxOptionsResponseResolvers<ContextType>;
  ...
  UpdateCouponResponseOrError?: UpdateCouponResponseOrErrorResolvers<ContextType>;
  UpdateFaqResponseOrError?: UpdateFaqResponseOrErrorResolvers<ContextType>;
  ...
  UpdateTaxOptionsResponseOrError?: UpdateTaxOptionsResponseOrErrorResolvers<ContextType>;
