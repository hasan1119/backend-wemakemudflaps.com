 ...
 */
export function mapCategoryRecursive(category: Category | null): any {
  if (!category) {
    return null;
  }
  return {
 ...
 */
export function mapProductPrice(price: ProductPrice | null): any {
  if (!price) {
    return null;
  }
  return {
 ...
 */
export async function mapProductRecursive(
  product: Product,
