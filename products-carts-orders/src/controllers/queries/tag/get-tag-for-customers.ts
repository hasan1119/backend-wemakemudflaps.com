...
import {
  ...
  QueryGetAllTagsArgs,
  QueryGetAllTagsForCustomersArgs,
} from "../../../types";
import {
  paginationSchema,
  tagsSortingSchema,
} from "../../../utils/data-validation";
import { paginateTags } from "../../services";
 ...
 * 2. Attempts to retrieve tags and total count from Redis for performance.
 * 3. On cache miss, fetches tags from the database with pagination, search, and sorting.
 * 4. Maps database tags to cached format, including creator details.
 * 5. Caches tags and total count in Redis.
 ...
 */
export const getAllTagsForCustomers = async (
  _: any,
  args: QueryGetAllTagsForCustomersArgs,
  { user }: Context
