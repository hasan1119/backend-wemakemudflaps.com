 ...
 * 7. Retrieves or calculates user count per role, caching results in Redis.
 * 8. Constructs response with role details, including permissions and user counts.
 * 9. Returns a success response or error if validation, permission, or retrieval fails.
 *
...
export const getAllRoles = async (
  ...
  try {
    ...
    const cachedData = await getRolesAndCountFromRedis(
      page,
      limit,
      search,
      sortBy,
